...
if (str[0] == '0' || str[0] == '1' || str[0] == '2' ||
    ...
    str[0] == '9' || str[0] == '#' || isDelimiter(str[0]) == true)
return false;
return true;
}
...
void pass(char* str)
{
    ...
    while (right <= len && left <= right) {
        ...
        if (isDelimiter(str[right]) == true && left == right) {
            ...
            || str[right] == '=' || str[right] == '(' || str[right] == ')' || 
        	str[right] == '[' || str[right] == ']' || str[right] == '{' || str[right] == '}')
              {
...
int main()
{
char str[100] = "#include<stdio.h> void main(){int a,sum; sum=a+2;}"; 
pass(str); 
return 0;
}
